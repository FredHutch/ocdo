...
Fred Hutch and UW Medicine staff can schedule a DHC with typically 1-2 DaSL staff members on a variety of topics below.  
...
## Translational Project Feasibility
In 2026 we'll be rolling out net-new multimodal clinical data resources for translational use from the Translational Data and AI team in OCDO.  This Data House Call is a great way to support getting projects planned that will leverage resources we've built on [CARDS, our translational data platform](https://cards.fredhutch.org) (note, this resource requires a Fred Hutch login/affiliation).  Please check back regularly to keep up with what is coming online when. 


Use this [Data House Call](https://calendly.com/data-house-calls/feasibility) to:

- Discuss your proposed projects, 

- Determine what is feasible now, and what is coming, 

- Learn about what data management, computing and LLM/AI capabilities our platform provides,

- as well as provide your input on what data sources and types of support you'll need moving forward.


::: {.callout-tip appearance="simple"}
Schedule this [Data House Call](https://calendly.com/data-house-calls/feasibility).  
:::
...
## Using Healthcare Data (OMOP) (on hold)

We support research use of healthcare data in the OMOP data model for research to develop cohorts and queries that are useful for answering research questions. We also support facilitated data extract requests for research and can discuss what our team can help you with today and in the future as our team builds new translational data resources.

Use this Data House Call to meet with us about how we can help you with using OMOP healthcare data for research to answer questions such as:
...
::: {.callout-tip appearance="simple"}
**Note:** This Data House Call is on hold until our OMOP data model becomes available.  Stay tuned in June for more availability of data and support.  
:::
...
**Note:** this Data House Call is also good for finding out about the status of upcoming resources such as [CARDS, our translational data platform](http://cards.fredhutch.org/)
