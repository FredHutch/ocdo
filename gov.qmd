...
### Patient and Reserach Data Governance & Stewardship
...
Fred Hutch focused AI resources and governance processes are currently in development by OCDO in partnership with various subject matter experts in other departments and with our partners at UW Medicine (for clinical settings). More can be found on our [Centernet page](https://centernet.fredhutch.org/u/data-science-lab/ai.html) or you can email [dataprotection@fredhutch.org](mailto:dataprotection@fredhutch.org) with questions or to request an AI Review of your use case.  
