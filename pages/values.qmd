...
__Be kind.__ Kindness is key. We strive to offer each other grace, empathy and respect and work together through difficulties, even in tough conversations or working to solve hard problems. This means communicating respectfully, exhibiting patience, appreciating effort and a focus on psychological safety.  
...
__Build things that will help people.__ Our [Guiding Principles](../strategy.qmd#guiding-principles) drive what we choose to focus on and inform how we make it happen.  Sometimes that is helping people directly with training, community events, documentation or Data House Calls. Sometimes it is indirectly by building resources, software, infrastructure or processes that will help others. Our goal is to maximize our impact by enabling others.  


__Ship as soon as you can.__ Our success hinges on sharing drafts, prototypes, and ideas as soon as they can start to be useful for others. A rough draft shared widely holds far more value than a polished manuscript hidden on your desktop. By embracing the "work in the open" philosophy inspired by David Robinson’s model for understanding value, we maximize our opportunity for feedback, collaboration, and progress. The sooner we share, the sooner we improve—and the closer we get to meaningful impact.
...
__Be generous with credit.__ Acknowledgment is not a zero sum game - credit should be given generously, as widely as possible, and as liberally as is feasible. At the same time, mistakes will happen, and our focus should be on learning from them and finding solutions, not blame. Credit and acknowledgment should flow strongly down the org chart and if consequences of mistakes happen the responsibility for addressing them should flow up to the top, stopping with the Chief Data Officer.
