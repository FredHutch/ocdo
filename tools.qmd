...
We support the Fred Hutch’s diverse data community by providing visibility and communications around ongoing data-related projects through our regular "Data Noon" community calls and newsletters.  We present the current status of identified data programs and projects via two Data Noon series:  
...
Fred Hutch is building a secure, scalable, and supportable technical infrastructure foundation and tools that provide a centrally governed, democratized platform. Upon this system, the Fred Hutch community can build data products and tooling leveraging multimodal Fred Hutch patient clinical data to support clinical trials, precision oncology, data science, research and AI innovation.  Clinical and Research Data System (CARDS) will become the foundation of the Fred Hutch Cancer Center’s new translational data ecosystem.
